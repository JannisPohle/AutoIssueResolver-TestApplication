...
using TestLibrary.S2342.Abstractions;
using TestLibrary.S2342.Accessor;
using TestLibrary.S2342.Models;

namespace TestLibrary.S2342;
...
public class WeatherOrchestrator: IWeatherOrchestrator
{
  ...
  public async Task<Result<List<WeatherModelCelsius>>> GetWeather(int mode, string? argument = null)
  {
    try
    {
      var accessMode = (AccessMode)mode;
