...
public partial class WeatherOrchestratorTests
{
  ...
  {
    // Act
    var result = await _weatherOrchestrator.GetWeather(AccessMode.Mock.ToString());
    ...
    result.Payload.Should().NotBeEquivalentTo((await _weatherOrchestrator.GetWeather(AccessMode.Mock.ToString())).Payload);
  ...
  {
    // Act
    var result = await _weatherOrchestrator.GetWeather(AccessMode.Mock.ToString(), "asdf");
    ...
    result.Payload.Should().NotBeNullOrEmpty().And.HaveCount(10);
    result.Payload.Should().OnlyContain(x => x.Temperature >= -20 && x.Temperature <= 50);
    result.Payload.Should().BeEquivalentTo((await _weatherOrchestrator.GetWeather(AccessMode.Mock.ToString(), "asdf")).Payload);
    result.Payload.Should().AllSatisfy(weather => weather.Unit.Should().Be("Celsius"));
  }
  ...
  {
    // Act
    var result = await _weatherOrchestrator.GetWeather(AccessMode.Mock.ToString(), "5");
    ...
    result.Payload.Should().OnlyContain(x => x.Temperature >= -20 && x.Temperature <= 50);
    result.Payload.Should().BeEquivalentTo((await _weatherOrchestrator.GetWeather(AccessMode.Mock.ToString(), "5")).Payload);
    result.Payload.Should().AllSatisfy(weather => weather.Unit.Should().Be("Celsius"));
  }
  ...
  {
    // Act
    var result = await _weatherOrchestrator.GetWeather(AccessMode.Mock.ToString(), "0");
