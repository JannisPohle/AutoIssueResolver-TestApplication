...
public partial class WeatherOrchestratorTests
{
  ...
  {
    // Act
    var result = await _weatherOrchestrator.GetWeather(AccessMode.Mock, null);
    ...
    result.Payload.Should().NotBeEquivalentTo((await _weatherOrchestrator.GetWeather(AccessMode.Mock, null)).Payload);
  }
