...
{
  [Fact]
  public async Task WeatherOrchestrator_Mock_NoArgument_ShouldReturnDeterministicRandomData()
  {
    // Act
    ...
    result.Payload.Should().NotBeNullOrEmpty().And.HaveCount(1); // number of entries should default to the number of calls to the accessor
  ...
  [Fact]
  public async Task WeatherOrchestrator_Mock_NoArgument_ShouldReturnDeterministicData_WithMultipleInstances()
  {
