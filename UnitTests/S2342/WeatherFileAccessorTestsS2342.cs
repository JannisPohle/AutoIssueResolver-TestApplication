...
public partial class WeatherOrchestratorTests
{
  ...
  {
    // Act
    var result = await _weatherOrchestrator.GetWeather(1);
  ...
  {
    // Act
    var result = await _weatherOrchestrator.GetWeather(1, "TestFiles/WeatherForecast_10Entries.json");
  ...
  {
    // Act
    var result = await _weatherOrchestrator.GetWeather(1, "TestFiles/EmptyWeatherForecast.json");
  ...
  {
    // Act
    var result = await _weatherOrchestrator.GetWeather(1, "TestFiles/InvalidWeatherForecast.json");
  ...
  {
    // Act
    var result = await _weatherOrchestrator.GetWeather(1, $"TestFiles/{Guid.NewGuid()}.json");
