...
public partial class WeatherOrchestratorTests
{
  ...
  {
    // Act
    var result = await _weatherOrchestrator.GetWeather(AccessMode.File.ToString());
  ...
  {
    // Act
    var result = await _weatherOrchestrator.GetWeather(AccessMode.File.ToString(), "TestFiles/WeatherForecast_10Entries.json");
  ...
  {
    // Act
    var result = await _weatherOrchestrator.GetWeather(AccessMode.File.ToString(), "TestFiles/EmptyWeatherForecast.json");
  ...
  {
    // Act
    var result = await _weatherOrchestrator.GetWeather(AccessMode.File.ToString(), "TestFiles/InvalidWeatherForecast.json");
  ...
  {
    // Act
    var result = await _weatherOrchestrator.GetWeather(AccessMode.File.ToString(), $"TestFiles/{Guid.NewGuid()}.json");
